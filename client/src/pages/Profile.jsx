...
function Profile() {
  ...
  return <div className="p-3 max-w-lg mx-auto">
    ...
    <form className="flex flex-col gap-4">
      <img src={user.currentUser.avatar} alt="avatar" className="rounded-full h-24 w-24 object-cover hover:cursor-pointer self-center mt-2" />
      ...
      <button className="bg-slate-700 text-white p-3 rounded-lg mt-4 uppercase hover:opacity-95 disabled:opacity-80">Update</button>
    </form>
